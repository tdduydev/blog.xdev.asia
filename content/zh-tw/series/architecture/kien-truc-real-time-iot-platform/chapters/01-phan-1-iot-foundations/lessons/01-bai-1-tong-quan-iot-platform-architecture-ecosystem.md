...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ 建築 — 第 1 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 1 課：物聯網平台概述 -</tspan>
      <tspan x="60" dy="42">建築與生態系統</tspan>
  </text>
...
![第 1 課：物聯網平台概述 - 架構與生態系統](/storage/uploads/2026/03/iot-bai-1-diagram.webp)

## 簡介

物聯網生態系概述。物聯網架構層：裝置、閘道、雲端、應用程式。物聯網協定比較。工業 4.0 和數位轉型。
...
物聯網生態系統概述是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。

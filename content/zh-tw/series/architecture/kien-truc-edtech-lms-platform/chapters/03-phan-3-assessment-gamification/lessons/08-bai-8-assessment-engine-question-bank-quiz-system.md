...
title: 第 8 課：評量引擎 - 題庫與測驗系統
slug: bai-8-assessment-engine-question-bank-quiz-system
description: 題型：MCQ、編碼、論文、配對。質疑銀行管理。測驗生成演算法。反作弊：監考、隨機化、時間限制。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：評量引擎 - 問題庫 &</tspan>
      <tspan x="60" dy="42">測驗系統</tspan>
  </text>
...
![第 8 課：評量引擎 - 題庫與測驗系統](/storage/uploads/2026/03/edtech-bai-8-diagram.webp)

## 簡介

題型：MCQ、編碼、論文、配對。質疑銀行管理。測驗生成演算法。反作弊：監考、隨機化、時間限制。
...
問題類型：MCQ、編碼、論文、配對是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。

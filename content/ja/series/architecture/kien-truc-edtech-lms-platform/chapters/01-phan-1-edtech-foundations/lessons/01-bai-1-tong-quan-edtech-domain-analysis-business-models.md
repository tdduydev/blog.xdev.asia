...
title: 'レッスン 1: EdTech の概要 - ドメイン分析とビジネス モデル'
slug: bai-1-tong-quan-edtech-domain-analysis-business-models
description: >-
  EdTech の状況: MOOC、企業トレーニング、K-12、言語学習。ビジネス モデル:
  サブスクリプション、マーケットプレイス、フリーミアム。ベトナムのEdTech市場。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 1: EdTech の概要 - ドメイン分析</tspan>
...
![レッスン 1: EdTech の概要 - ドメイン分析とビジネス モデル](/storage/uploads/2026/03/edtech-bai-1-diagram.webp)

## はじめに

EdTech の状況: MOOC、企業トレーニング、K-12、言語学習。ビジネス モデル: サブスクリプション、マーケットプレイス、フリーミアム。ベトナムのEdTech市場。

---

## 1. EdTech の状況: MOOC、企業トレーニング、K-12、語学学習

### 1.1 基本概念

EdTech の展望: MOOC、企業トレーニング、K-12、言語学習は、この分野で最も重要なトピックの一部です。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. ビジネス モデル: サブスクリプション、マーケットプレイス、フリーミアム
...
このレッスンでは、EdTech の概要 - ドメイン分析とビジネス モデルについて学びました。重要なポイント:

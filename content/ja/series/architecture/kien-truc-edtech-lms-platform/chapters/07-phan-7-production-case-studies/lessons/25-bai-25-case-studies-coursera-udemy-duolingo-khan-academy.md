...
title: 'レッスン 25: ケーススタディ - Coursera、Udemy、Duolingo、Khan Academy'
slug: bai-25-case-studies-coursera-udemy-duolingo-khan-academy
description: >-
  実際の EdTech プラットフォームを分析します: Coursera (学位プログラム)、Udemy (マーケットプレイス)、Duolingo
  (ゲーミフィケーション)、Khan Academy (無料教育)。教訓。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 25: ケーススタディ - Coursera、Udemy、</tspan>
      <tspan x="60" dy="42">Duolingo とカーン アカデミー</tspan>
  </text>
...
実際の EdTech プラットフォームを分析します: Coursera (学位プログラム)、Udemy (マーケットプレイス)、Duolingo (ゲーミフィケーション)、Khan Academy (無料教育)。教訓。

---

## 1. 実際の EdTech プラットフォームの分析: Coursera (学位プログラム)、Udemy (マーケットプレイス)、Duolingo (ゲーミフィケーション)、Khan Academy (無料教育)

### 1.1 基本概念

実際の EdTech プラットフォームの分析: Coursera (学位プログラム)、Udemy (マーケットプレイス)、Duolingo (ゲーミフィケーション)、Khan Academy (無料教育) は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、Coursera、Udemy、Duolingo、Khan Academy のケーススタディについて学びました。重要なポイント:

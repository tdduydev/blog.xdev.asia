...
description: >-
  FinTech ドメイン、主要分野 (決済、融資、銀行、保険、投資) を分析します。ビジネスモデルと収益源。ベトナムおよび国際的な規制の状況。 2026
  年の FinTech エコシステムとトレンド。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 1: FinTech の概要 - ドメイン分析</tspan>
      <tspan x="60" dy="42">& ビジネスモデル</tspan>
  </text>
...
![レッスン 1: FinTech の概要 - ドメイン分析とビジネス モデル](/storage/uploads/2026/03/fintech-bai-1-diagram.webp)
...
**FinTech** は、**金融**と**テクノロジー**を組み合わせたもので、テクノロジーを使用して従来の金融サービスを改善、自動化し、破壊します。
...
- 分散システムの基本的な理解
- 少なくとも 1 つのバックエンド フレームワーク (Spring Boot、Node.js、Go) の使用経験
・データベースの基礎知識（SQL、トランザクション）

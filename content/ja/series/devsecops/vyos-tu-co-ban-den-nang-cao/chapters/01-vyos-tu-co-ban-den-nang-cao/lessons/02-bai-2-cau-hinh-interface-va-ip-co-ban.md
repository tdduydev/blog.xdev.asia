...
<img src="/storage/uploads/2026/04/vyos-02-interface-ip.webp" alt="インターフェース設定 và IP cơ bản" style="display:block;margin:24px auto 32px auto;max-width:700px;width:100%;border-radius:18px;box-shadow:0 4px 32px #0002" loading="lazy" />

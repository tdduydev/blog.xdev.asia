...
<img src="/storage/uploads/2026/04/k8s-cert-ckad-bai10-networkpolicy.webp" alt="NetworkPolicy — ingress/egress rules, default-deny and AND/OR logic" style="max-width: 800px; width: 100%; border-radius: 12px;" />
